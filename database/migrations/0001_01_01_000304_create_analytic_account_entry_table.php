...
return new class extends Migration
{
    ...
    {
        Schema::create('analytic_account_entry', function (Blueprint $table) {
            ...
            */
            ...
            $table->ulid('analytic_account_id');
            ...
            */
            ...
            $table->foreign('analytic_account_id')->references('id')->on('analytic_accounts')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('analytic_account_entry');
    }
};
