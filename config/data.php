...
return [
     ...
     * method. By default, the data is being validated only when a request is passed. This
    ...
    'commands' => [
        ...
        /*
         * Provides the default configuration for the `make:data` command. These settings can be overridden with options
        ...
        'make' => [
            ...
            /*
             * The default namespace for generated Data classes. This exists under the application's root
             * namespace, so the default 'Data` will end up as '\App\Data', and generated Data classes will be
             * placed in the app/Data/ folder. Data classes can live anywhere, but this is
             * where `make:data` will put them.
             */
            'namespace' => 'Data',
