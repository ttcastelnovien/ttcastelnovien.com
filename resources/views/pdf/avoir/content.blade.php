...
<table style="width: 100%; margin-top: 10mm; margin-bottom: 10mm; table-layout: fixed; border-collapse: collapse;">
    ...
    <tr style="vertical-align: middle;">
        <td></td>
        <td colspan="2" style="padding: 2mm 3mm; border: 2pt solid {{ $gray['600'] }}; border-bottom-color: {{ $primary['600'] }}; text-align: left; text-transform: uppercase;">Total H.T.</td>
    ...
    <tr style="vertical-align: middle; font-size: 12pt;">
        <td></td>
        <td colspan="2" style="padding: 2mm 3mm; border: 2pt solid {{ $primary['600'] }}; text-align: left; text-transform: uppercase; background-color: {{ $primary['600'] }}; color: white; font-weight: 700;">Total T.T.C.</td>
